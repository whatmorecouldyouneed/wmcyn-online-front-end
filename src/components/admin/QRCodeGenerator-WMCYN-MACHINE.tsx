    ...
    try {
      ...
      const request: GenerateQRCodeRequest = {
        target: productSet ? {
          ...
          type: "AR_SESSION", 
          sessionId: arSession!.sessionId || arSession!.id!
        },
        ...
        redeemPolicy: {
          ...
          startAt: policy.timeWindow?.startTime,
          endAt: policy.timeWindow?.endTime,
          geoFence: policy.geofence ? {
            lat: policy.geofence.latitude,
            lng: policy.geofence.longitude,
            radiusMeters: policy.geofence.radiusMeters
          } : undefined
        }
      };
